...
public:
	...
	UFUNCTION(Server, Unreliable, Category = "VoiceChatUniversal")
		void RPCClientTransmitVoiceData(TArray<uint8> const &data, int32 sampleRate, int32 numchannels, int32 PCMSize, int32 opusFramePerSec, bool _isGlobal, int _radioChannel, bool _useRange, float _maxRange);
